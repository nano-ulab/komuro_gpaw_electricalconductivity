...
plt.savefig('FeC-graphene_OFF_TransimissonFunc.png')
plt.close()
...
for i in range(len(pdos_ne)):
    ...
    # plt.legend()
    # plt.savefig('FeC-graphene_OFF_PDOS_'+str(i)+'.png')
plt.savefig('FeC-graphene_OFF_PDOS_FeC.png')
plt.close()
...
plt.xlabel('U [V]')
plt.ylabel('I [A]')
plt.savefig('FeC-graphene_OFF_IV.png')
plt.close()
...
plt.xlabel('U [V]')
plt.ylabel('I [A]')
plt.savefig('FeC-graphene_OFF_logIV.png')
plt.close()
